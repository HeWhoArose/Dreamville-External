...
export class EntityRegistry {
	...
	public static fromConfirmedCharacter(storyId: string, character: any): EntityCardInput {
		...
		return {
			...
			progression: progression ? { level: Number(coreStats?.level || 1), classId: progression.classId, subclassId: progression.subclassId, speciesId: progression.speciesId, featIds: normalizeArray(progression.featIds) } : undefined,
